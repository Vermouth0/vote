...
public class MainActivity extends AppCompatActivity {
    ...
    private String doVote(String voteStr){
        ...
        try {
            ...
            String urlPath = "http://10.63.242.10:8080/vote/GetVote";
            ...
            //获得输出流，向服务器写入数据
            OutputStream outputStream = httpURLConnection.getOutputStream(); outputStream.write(data);
